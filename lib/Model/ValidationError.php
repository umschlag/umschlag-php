...
class ValidationError implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'status' => 'int',
        'message' => 'string',
        'errors' => '\Umschlag\Model\ValidationErrorErrors[]'
    ];
     ...
     * Gets errors
     *
     * @return \Umschlag\Model\ValidationErrorErrors[]|null
     */
     ...
     * Sets errors
     *
     * @param \Umschlag\Model\ValidationErrorErrors[]|null $errors errors
     *
     * @return $this
     */
